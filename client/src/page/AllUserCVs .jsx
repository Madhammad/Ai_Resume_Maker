...
export default function AllUserCVs() {
    ...
    const fetchCVs = async () => {
      try {
        ...
        const { data } = await axios.get(
          `${URL_BACKEND}/api/Aicv/userallCV/${currentUser._id}`,
          {
        ...
        if (data.success) {
          // console.log("Fetched CVs:", data.data.cvs);
          setLoading(false);
    ...
    <div>
      <div className="w-full px-4 md:px-8 my-8 md:my-12">
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-green-800 leading-tight text-center">
          {currentUser.username}'s CVs
        </h1>
        <div className="rounded-xl p-4 md:p-6 shadow-xl grid grid-cols-3 w-full relative flex-wrap mi    n-h-[200px]">
          {loading && (
                    ...
                    <div className="mx-auto bg-white shadow-xl p-2  border border-gray-200">
                      ...
                      <div className="flex flex-row   font-sans">
                        ...
                        >
                          ...
                          <div>
                            <h2
                              className={`text-[6px] ${cv.color.textcolor} font-semibold `}
                            >
                              Contact
                            </h2>
                        ...
                        <div className="w-2/3  p-1 ">
                          ...
                          {cv?.projects?.length > 0 && (
                            <div
                              className={`my-2 ${cv.color.bgcolor} bg-opacity-10 p-1 rounded-lg`}
                            >
                              <h2
                          ...
                          {cv?.experience?.length > 0 && (
                            <div
                              className={` ${cv.color.bgcolor} bg-opacity-10 p-1 rounded-lg`}
                            >
                              <h2
                                className={`text-[6px] font-semibold ${cv.color.textcolor}  mb-1`}
                              >
